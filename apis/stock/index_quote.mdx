---
title: 'Index Quote'
openapi: 'POST /v1/stock/index-quote'
---

## 指数行情

**URL**: `/v1/stock/index-quote`
**方法**: `POST`  
**描述**: 获取股票指数的当前和历史行情数据。
...
**cURL**
```bash
curl -X POST https://api.reportify.cn/v1/stock/index-quote \
...
url = "https://api.reportify.cn/v1/stock/index-quote"
headers = {
