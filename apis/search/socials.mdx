...
openapi: 'POST /v2/search/socials'
---

## 社交媒体搜索

**URL**: `/v2/search/socials`  
**方法**: `POST`  
**描述**: 搜索社交媒体内容和市场情绪。
...
| channel_ids      | array[str]   | 否   | 频道 ID 列表，用于筛选特定社交媒体来源。                             |
...
**cURL**
```bash
curl -X POST https://api.reportify.cn/v2/search/socials \
...
url = "https://api.reportify.cn/v2/search/socials"
headers = {
...
```json
{
  "docs": [
    {
      "doc_id": "1046915273103380486",
      "title": "特斯拉中国宣布全系降价，市场反应热烈",
      "summary": "### 内容要点\n- 特斯拉中国宣布 Model 3 和 Model Y 降价\n- 社交媒体上讨论热度飙升\n...",
      "category": "socials",
      ...
      "score": 0.9521,
      "url": "https://reportify.cn/socials/1046915273103380486"
    }
  ],
  "total_count": 1,
  "took_ms": 65
