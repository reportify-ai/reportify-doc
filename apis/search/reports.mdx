...
openapi: 'POST /v2/search/reports'
---
...
| channel_ids      | array[str]   | 否   | 频道 ID 列表，用于筛选特定机构的报告。                               |
...
**cURL**
```bash
curl -X POST https://api.reportify.cn/v2/search/reports \
...
url = "https://api.reportify.cn/v2/search/reports"
headers = {
