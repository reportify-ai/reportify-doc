...
const response = await fetch('https://api.reportify.cn/v1/quant/quotes/minute?symbol=000001&start_datetime=2024-01-01%2009:30:00&end_datetime=2024-01-01%2015:00:00&market=cn', {
  method: 'GET',
  headers: {
