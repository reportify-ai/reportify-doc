...
openapi: 'POST /v1/quant/quotes/minute'
---
...
```bash cURL
curl -X POST https://api.reportify.cn/v1/quant/quotes/minute \
...
const response = await fetch('https://api.reportify.cn/v1/quant/quotes/minute', {
  method: 'POST',
  headers: {
