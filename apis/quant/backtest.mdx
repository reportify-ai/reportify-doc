...
<ParamField body="entry_formula" type="string" required>
  买入/开仓公式，结果大于 0 时触发买入
...
<ParamField body="labels" type="object">
  标签字典，用于在每日数据中返回额外的指标值（可选）
  
  <Expandable title="labels 示例">
    ```json
    {
      "ma5": "MA(5)",
      "ma10": "MA(10)",
...
```json
{
    "entry_formula": "(RSI(14) < 30) & (CLOSE > MA(20))",
    "exit_formula": "(RSI(14) > 70) | (CLOSE < MA(20))",
    "symbol": "600036",
    "start_date": "2024-01-01",
    "end_date": "2025-01-01",
    "commission": 0.0003,
