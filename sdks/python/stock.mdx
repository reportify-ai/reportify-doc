...
```python
# 通过股票代码查询（支持多个，逗号分隔）
info = client.stock.overview(symbols="US:AAPL,HK:00700")
print(info)
...
<ParamField path="symbols" type="string">
  股票代码，支持多个，用逗号分隔，如 `US:AAPL,HK:00700`
</ParamField>
...
```python
breakdown = client.stock.revenue_breakdown("US:AAPL", limit=6)
print(breakdown)
```
...
stocks = client.stock.screener(
    country="US",
    market_cap_more_than=1e10,  # 100亿美元以上
    pe_ttm_lower_than=30,
    limit=50
)
```

<ParamField path="market_cap_more_than" type="float">
  市值大于
</ParamField>

<ParamField path="market_cap_lower_than" type="float">
  市值小于
</ParamField>

<ParamField path="price_more_than" type="float">
  股价大于
</ParamField>

<ParamField path="price_lower_than" type="float">
  股价小于
</ParamField>

<ParamField path="change_percentage_more_than" type="float">
  涨跌幅大于（如 0.02 表示 2%）
</ParamField>

<ParamField path="change_percentage_lower_than" type="float">
  涨跌幅小于
</ParamField>

<ParamField path="volume_more_than" type="int">
  成交量大于
</ParamField>

<ParamField path="volume_lower_than" type="int">
  成交量小于
</ParamField>
...
<ParamField path="exchange" type="str">
  交易所代码：`NASDAQ`, `NYSE`, `HKEX`
</ParamField>

<ParamField path="dividend_yield_more_than" type="float">
  股息率大于
</ParamField>

<ParamField path="dividend_yield_lower_than" type="float">
  股息率小于
</ParamField>

<ParamField path="pe_ttm_more_than" type="float">
  市盈率（TTM）大于
</ParamField>

<ParamField path="pe_ttm_lower_than" type="float">
  市盈率（TTM）小于
</ParamField>
